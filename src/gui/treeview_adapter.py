...
class TreeviewAdapter:
    ...
    def __init__(self, treeview: ttk.Treeview):
        ...
        self._active_sort_column: Optional[str] = None
        self._active_sort_reverse: bool = False
    ...
    def on_data_changed(self) -> None:
        ...
        if self._active_sort_column:
            try:
                self.sort_by_column(self._active_sort_column, self._active_sort_reverse)
            except Exception:
                pass
