...
from src.gui.helpers import center_window, get_ui_font
...
def open_backup_manager(root: tk.Widget, status_var: tk.StringVar) -> None:
    ...
    ttk.Label(listframe, text='Available Backups:', font=get_ui_font(size_delta=1, weight='bold')).pack(anchor=tk.W)
